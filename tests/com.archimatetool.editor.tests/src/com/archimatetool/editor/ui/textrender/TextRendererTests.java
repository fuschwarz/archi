...
public class TextRendererTests {
    ...
    public void render_PropertyKey_Indirection() {
        ...
        TextRendererTests.addProperty(dmo.getArchimateConcept(), "en", "English");
        TextRendererTests.addProperty(dmo.getArchimateConcept(), "fr", "French");
    ...
    public void render_PropertyKey_MultipleIndirection1() {
        ...
        TextRendererTests.addProperty(dmo.getArchimateConcept(), "p3", "Result!");
    ...
    public void render_PropertyKey_MultipleIndirection2() {
        ...
        TextRendererTests.addProperty(dmo.getArchimateModel(), "p1", "$model{property:p2}");
        TextRendererTests.addProperty(dmo.getArchimateModel(), "p2", "$model{property:p3}");
        TextRendererTests.addProperty(dmo.getArchimateModel(), "p3", "Result!");
